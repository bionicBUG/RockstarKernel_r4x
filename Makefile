...
KBUILD_CFLAGS   += $(call cc-disable-warning,bool-compare)
KBUILD_CFLAGS   += $(call cc-disable-warning,switch-unreachable)
KBUILD_CFLAGS   += $(call cc-disable-warning,no-typedef-redefinition)
KBUILD_CFLAGS   += $(call cc-disable-warning,no-parentheses-equality)
KBUILD_CFLAGS   += $(call cc-disable-warning,no-non-literal-null-conversion)
KBUILD_CFLAGS   += $(call cc-disable-warning,no-enum-conversion)
KBUILD_CFLAGS   += $(call cc-disable-warning,unused-function)
