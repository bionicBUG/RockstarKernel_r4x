...
static struct pll_freq_tbl apcs_c0_pll_freq[] = {
	...
	F_APCS_PLL(1363000000,  71, 0x0, 0x1, 0x0, 0x0, 0x0),
	F_APCS_PLL(1382000000,  72, 0x0, 0x1, 0x0, 0x0, 0x0),
...
static struct pll_freq_tbl apcs_c1_pll_freq[] = {
	...
	F_APCS_PLL(1651000000, 86, 0x0, 0x1, 0x0, 0x0, 0x0),
};
...
static struct clk_freq_tbl ftbl_gcc_oxili_gfx3d_clk_8937_475MHz[] = {
	...
	F_SLEW( 620000000, 1240000000,	  gpll3,	1,	0,	0),
        F_SLEW( 640000000, 1280000000,	  gpll3,	1,	0,	0),
	F_END
};
...
static void override_for_8937(int speed_bin)
{
	...
	if (speed_bin) {
		OVERRIDE_FMAX6(gfx3d,
			...
			HIGH, 500000000, SUPER_TUR, 620000000);
